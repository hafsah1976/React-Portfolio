      ...
      <div className="container mx-auto flex px-10 md:px-20 py-20 md:flex-row flex-col items-center">
        ...
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          ...
          <p className="mb-8 leading-relaxed">
            Learning at the bootcamp has been amazing. While I went through a series of emotions during the last weeks of bootcamp, I sincerely enjoyed working on the projects and the assignments. I am a student at the George Washington University Fullstack Web Development Bootcamp. During this program, I have had the opportunity to work on a variety of assignments and projects, which you can explore here. This portfolio is built with React and showcases a small sample of the work I've completed over the course of the program.
          </p>
        </div>
        {/* Right Column - Image */}
